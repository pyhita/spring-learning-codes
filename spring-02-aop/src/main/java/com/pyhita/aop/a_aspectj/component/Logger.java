...
public class Logger {
    ...
    @Before("execution(public * com.pyhita.aop.a_aspectj.service.FinanceService.*(..))")
    public void beforePrint() {
        System.out.println("Logger beforePrint run ......");
    }

    //    @After("execution(* com.linkedbear.spring.aop.b_aspectj.service.*.*(String)))")
    @After("@annotation(com.pyhita.aop.a_aspectj.component.Log)")
    ...
    @Around("execution(public * com.pyhita.aop.a_aspectj.service.FinanceService.addMoney(..))")
    ...
    @Pointcut("execution(* com.pyhita.aop.a_aspectj.service.*.*(String)))")
